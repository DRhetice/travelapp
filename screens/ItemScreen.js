    ...
    <SafeAreaView className="flex-1 relative">
      <ScrollView className="flex-1 px-4 py-6">
        <View className="relative bg-white shadow-lg">
          ...
          />
          <View className="absolute flex-row inset-x-5 top-5 justify-between">
            <TouchableOpacity
            ...
            <TouchableOpacity className="w-8 h-8 rounded-md items-center justify-center bg-[#06b2be] ">
              <FontAwesome name="heartbeat" size={24} color="#fff" />
            </TouchableOpacity>
          </View>

          <View className="absolute flex-row inset-x-0 bottom-5 justify-between items-center px-2">
            <View className="flex-row space-x-2 items-center">
              <Text className="text-[12px] font-bold text-gray-100 ">
                {/*data?.price_level*/} 
              </Text>
              <Text className="text-[37px] font-bold text-gray-100 ">
                {data?.price}
              </Text>
            </View>

            <View className="px-2 py-1 mx-2 h-6 rounded-md bg-teal-100 ">
              <Text>
                {data?.open_now_text}
              </Text>
            </View>
